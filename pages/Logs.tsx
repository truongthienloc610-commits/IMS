  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-3xl font-bold tracking-tight text-primary">Lịch sử sử dụng</h1>
          ...
          <Table>
            ...
            <TableBody>
              {filteredLogs.map((log) => (
                <TableRow key={log.id}>
                  <TableCell className="font-mono text-xs">{log.asset_id}</TableCell>
                  <TableCell className="font-medium">{log.asset_name}</TableCell>
                  <TableCell>
                    <Badge variant={
